...
from keras.layers import Input, Dense, Reshape, BatchNormalization, UpSampling2D, Conv2D, Activation, LeakyReLU, \
    Dropout, ZeroPadding2D, Flatten
...
def save_imgs(generator, epoch, batch):
    ...
    for i in range(r):
        for j in range(c):
            ...
            axs[i, j].axis('off')
            cnt += 1
    fig.savefig("data/generated/mnist_%d_%d.png" % (epoch, batch))
    plt.close()
